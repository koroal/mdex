...
"Usage: mdex [-wsdnt] [-l lang] [-c ranges] series [group...]\n\n"
"The first argument w/o dash must be a series link or uuid\n\n"
"-w        Overwrite any existing files\n"
"-s        Save files into a subdirectory\n"
"-d        Report multiple chapter versions\n"
"-n        Only check and do not download anything\n"
"-t        Include chapter title in filenames\n"
"-l lang   Choose language by code (default is 'en')\n"
"-c ranges Choose chapters by ranges list (default is '-')\n\n"
